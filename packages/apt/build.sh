...
termux_step_post_make_install() {
	{
		echo "# ApexStudio fork repository"
		echo "deb https://apex-studio-dev.github.io/termux-packages/apt/termux-main/ stable main"
		echo "deb https://debs.apexstudiodev.my.id stable main"
